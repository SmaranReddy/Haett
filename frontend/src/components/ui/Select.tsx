    ...
    return (
      <div className="space-y-1.5">
        ...
        <select
          ...
          className={cn(
            'block w-full rounded-lg border bg-white px-3 py-2.5 text-sm text-gray-900 caret-gray-900 shadow-sm transition-all duration-150 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-0',
            error
